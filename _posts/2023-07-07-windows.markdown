---
layout: post
title:  Actualizando la versión de Windows Server en una máquina virtual de Azure
description: Es posible realizar un cambio de versión de Windows Server realizando la actualización sobre la propia máquina virtual.
